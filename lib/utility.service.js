...
exports.PERSIAN_MONTH_DAYS_COUNT = [31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 30];
exports.PERSIAN_MONTH_NAMES = [
    'فروردین',
    'اردیبهشت',
    'خرداد',
    'تیر',
...
var UtilityService = /** @class */ (function () {
    function UtilityService() {
        ...
        this.date = (function (_) {
            var PERSIAN_EPOCH = 1948320.5, GREGORIAN_EPOCH = 1721425.5;
            var date = {
                persian: {
            ...
            date.persian.getDaysOfoMonth = function (idx) {
                var count = exports.PERSIAN_MONTH_DAYS_COUNT[idx];
                var res = [];
            ...
            date.persian.getDayOfWeek = function (y, m, d) {
                ...
                var month = +m - 1;
                var day = +d;
                var daysOfYear = exports.PERSIAN_MONTH_DAYS_COUNT.reduce(function (a, b, idx) {
                    if (idx == month)
                        return a + day;
                    if (idx > month)
                        return a;
            ...
            date.persian.foretimeMonthOfYear = function () {
                return exports.PERSIAN_MONTH_NAMES.filter(function (item, idx) { return idx <= +date.persian.now().month - 1; });
            };
            ...
            (date.georgian.getRelativeDay = function (n) {
                ...
                (date.julian.to.georgian = function (jd) {
                    var wjd, depoch, quadricent, dqc, cent, dcent, quad, dquad, yindex, dyindex, year, month, day, yearday, leapadj;
